...
<head>
  ...
  <body id="page-top">
  <?php
    // Grab request ID from previous page
    $requestId = $_SESSION['animalReqId'];
        ...
        <div class="container-fluid">
          ...
          <div>
            <div class="d-sm-flex align-items-center justify-content-between col-lg-6 mb-4">
              <h1 class="h3 mb-0 text-gray-800">Animal Request</h1>
            </div>
          </div>

          <div class="col-lg-6 mb-4">
            <p class="mb-4"><?php echo '<b>Request ' . $requestId . '</b> has been processed.';?></p>
          </div>

          <div class="col-md-12">
            <button type="submit" class="btn btn-primary py-2 px-4 text-white" onclick='returnHome()'>
              Return Home
            </button>
          </div>
  ...
  function returnHome() {
    window.location.replace("employeeHome.php");
  }
  </script>
