        ...
        <div class="container-fluid">
          ...
          <div>
            <div class="d-sm-flex align-items-center justify-content-between col-lg-6 mb-4">
              <h1 class="h3 mb-0 text-gray-800">Foster Application</h1>
            </div>
          </div>

          <div class="col-lg-6 mb-4">
            <p class="mb-4"><?php echo '<b>Application ' . $applicationId . '</b> has been processed.';?></p>
          </div>
