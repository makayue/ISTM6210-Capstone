    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800"><b>Animal Profile</b></h1>

            <!-- Foster ID -->
          <div class="row mb-4 col-md-12">
            <label for='appId'>Animal ID</label>
            <div class="row mb-4 col-md-12">
              <input type='text' class='form-control col-md-3' id='appId' disabled value=<?php echo $animalId;?>>
            </div>
          </div>
          <!-- End Foster ID -->
                  ...
                  <table class="table table-bordered table-sm table-fixed" width="100%" cellspacing="0">
                    <?php
                        ...
                        $sql = "SELECT animalName,
                                       ...
                                       houseTrained,
                                       registrationDate,
                                       DATEDIFF(CURRENT_TIMESTAMP, registrationDate) AS duration,
                                       specialNeeds,
                                       goodWithDogs,
                                       goodWithCats,
                                       goodWithOther,
                        ...
                        if ($result->num_rows > 0) {
                          ...
                          while($row = $result->fetch_assoc()) {
                            echo "<tr><th style='width: 50%'>Animal Name</th><td style='width: 50%'>" . $row ['animalName'] . "</td></tr>" .
                                 "<tr><th>Foster Status</th><td>" . $row['fosterStatus'] . "</td></tr>" .
                                 "<tr><th>Location</th><td>" . $row['location'] . "</td></tr>" .
                                 "<tr><th>Age (in months)</th><td>" . $row['age'] . "</td></tr>" .
                                 "<tr><th>Microchip ID</th><td>" . $row['microchipId'] . "</td></tr>" .
                                 "<tr><th>Species</th><td>" . $row['species'] . "</td></tr>" .
                                 "<tr><th>Primary Breed</th><td>" . $row['breed1'] . "</td></tr>" .
                                 "<tr><th>Secondary Breed</th><td>" . $row['breed2'] . "</td></tr>" .
                                 "<tr><th>Sex</th><td>" . $row['sex'] . "</td></tr>" .
                                 "<tr><th>Primary Color</th><td>" . $row['color1'] . "</td></tr>" .
                                 "<tr><th>Secondary Color</th><td>" . $row['color2'] . "</td></tr>" .
                                 "<tr><th>Size</th><td>" . $row['size'] . "</td></tr>" .
                                 "<tr><th>Sterilized?</th><td>" . $row['sterilized'] . "</td></tr>" .
                                 "<tr><th>Vaccinations Up-To-Date</th><td>" . $row['vaccinated'] . "</td></tr>" .
                                 "<tr><th>House Trained</th><td>" . $row['houseTrained'] . "</td></tr>" .
                                 "<tr><th>Registration Date</th><td>" . $row['registrationDate'] . "</td></tr>" .
                                 "<tr><th>Shelter Tenure</th><td>" . $row['duration'] . "</td></tr>" .
                                 "<tr><th>Special Needs</th><td>" . $row['specialNeeds'] . "</td></tr>" .
                                 "<tr><th>Good With Dogs</th><td>" . $row['goodWithDogs'] . "</td></tr>" .
                                 "<tr><th>Good With Cats</th><td>" . $row['goodWithCats'] . "</td></tr>" .
                                 "<tr><th>Good With Other</th><td>" . $row['goodWithOther'] . "</td></tr>" .
                                 "<tr><th>Good With Children</th><td>" . $row['goodWithChildren'] . "</td></tr>";
                          }
                        } else {
                          echo "0 results";
                        }
            ...
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Home Requirements</h6>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-bordered table-sm table-fixed" width="100%" cellspacing="0">
                        ...
                        if ($result->num_rows > 0) {
                          ...
                          while($row = $result->fetch_assoc()) {
                            echo "<tr><th style='width: 50%'>Home Type</th><td style='width: 50%'>" . $row['homeType'] . "</td></tr>" .
                                 ...
                                 "<tr><th>Home Preference</th><td></td></tr>" .
                                 "<tr><td>With Men</td><td>" . $row['homePrefWithMen'] . "</td></tr>" .
                                 "<tr><td>With Women</td><td>" . $row['homePrefWithWomen'] . "</td></tr>" .
                                 "<tr><td>With Children</td><td>" . $row['homePrefWithChildren'] . "</td></tr>" .
                                 "<tr><td>With Pets</td><td>" . $row['homePrefWithPets'] . "</td></tr>";
                          }
                        } else {
                          echo "0 results";
                        }
                  ...
                  <table class="table table-bordered table-sm table-fixed" width="100%" cellspacing="0">
                    <?php
                        ...
                        $sql = "SELECT foster_activity.activityId AS activityId,
                                       ...
                                       foster_activity.fosterId AS fosterId,
                                ...
                                WHERE foster_activity.animalId = $animalId";
                        ...
                        if ($result->num_rows > 0) {
                          ...
                          while($row = $result->fetch_assoc()) {
                            echo "<tr><th style='width: 50%'>Activity ID</th><td style='width: 50%'>" . $row ['activityId'] . "</td></tr>" .
                                 ...
                                 "<tr><th>Foster Id</th><td>" . $row['fosterId'] . "</td></tr>" .
                                 "<tr><th>Foster Name</th><td>" . $row['fosterName'] . "</td></tr>" .
